...
local configpath=uci:get("AdGuardHome1","AdGuardHome","configpath") or "/etc/AdGuardHome1.yaml"
local binpath=uci:get("AdGuardHome1","AdGuardHome","binpath") or "/usr/bin/AdGuardHome1/AdGuardHome"
httpport=uci:get("AdGuardHome1","AdGuardHome","httpport") or "3000"
m = Map("AdGuardHome1", "AdGuard Home")
m.description = translate("Free and open source, powerful network-wide ads & trackers blocking DNS server.")
m:section(SimpleSection).template  = "AdGuardHome1/AdGuardHome_status"
...
local binmtime=uci:get("AdGuardHome1","AdGuardHome","binmtime") or "0"
local e=""
...
o.template = "AdGuardHome1/AdGuardHome_check"
...
o.default     = "/usr/bin/AdGuardHome1/AdGuardHome"
o.datatype    = "string"
o.optional = false
o.rmempty=false
...
o.default     = "/etc/AdGuardHome1.yaml"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
o.default     = "/usr/bin/AdGuardHome1"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome1/gfw2adg.sh del 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome1"))
end
o=s:option(Button,"gfwadd",translate("Add gfwlist"),translate(a))
o.optional = true
o.inputtitle=translate("Add")
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuardHome1/gfw2adg.sh 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuardHome1"))
end
...
o.default     = ""
o.datatype    = "string"
o.template = "AdGuardHome1/AdGuardHome_chpass"
o.optional = true
---- upgrade protect
...
local workdir=uci:get("AdGuardHome1","AdGuardHome","workdir") or "/usr/bin/AdGuardHome1"
...
o1.default     = "/usr/bin/AdGuardHome1"
o1.datatype    = "string"
o1.optional = false
...
o.cfgvalue = function(self, section)
	return fs.readfile("/usr/share/AdGuardHome1/links.txt")
end
o.write = function(self, section, value)
	fs.writefile("/usr/share/AdGuardHome1/links.txt", value:gsub("\r\n", "\n"))
end
...
function m.on_commit(map)
	...
	elseif ucitracktest=="0" then
		...
		if (fs.access("/var/run/AdGlucitest")) then
			uci:set("AdGuardHome1","AdGuardHome","ucitracktest","0")
			io.popen("/etc/init.d/AdGuardHome1 reload &")
		else
			fs.writefile("/var/run/AdGlucitest","")
			if (ucitracktest=="2") then
				uci:set("AdGuardHome1","AdGuardHome","ucitracktest","1")
			else
				uci:set("AdGuardHome1","AdGuardHome","ucitracktest","2")
			end
		end
		uci:commit("AdGuardHome1")
	end
